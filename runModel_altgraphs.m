...
sp2a = subplot('position',[0.35,0.1,0.25,0.18]);
sp2b = subplot('position',[0.65,0.1,0.25,0.18]);

sp3 = subplot('position',[0.35,0.4,0.6,0.15]);
sp4 = subplot('position',[0.35,0.6,0.6,0.15]);
sp6 = subplot('position',[0.35,0.8,0.6,0.15]);

sp5 = subplot('position',[0.05,0.1,0.25,0.45]);
...
%         display([imgPath,'img',num2str(imgIdx),'.png'])
        imwrite(img.cdata,[imgPath,'img',num2str(imgIdx,'%0.4d'),'.png']);
        imgIdx = imgIdx+1;
